...
public class ViewDataKasir extends JFrame {
    ...
    public ViewDataKasir() {
        ...
        lUsername.setBounds(10, 40, 100, 20);
        lPass.setBounds(10, 70, 100, 20);
        lNama.setBounds(10, 100, 100, 20);
        lJk.setBounds(10, 130, 100, 20);
        lNoTelp.setBounds(10, 160, 100, 20);
        lAlamat.setBounds(10, 190, 100, 20);
        tfId.setBounds(100, 10, 100, 20);
        tfUsername.setBounds(100, 40, 100, 20);
        tfPass.setBounds(100, 70, 100, 20);
        tfNama.setBounds(100, 100, 100, 20);
        tfJk.setBounds(100, 130, 100, 20);
        tfNoTelp.setBounds(100, 160, 100, 20);
        tfAlamat.setBounds(100, 190, 100, 20);
