...
public class ViewTampil extends JFrame {
    ...
    JTextField tfSearch, tfIdAngg, tfNamaAngg, tfIdBuku, tfJudulBuku;
    ...
    public ViewTampil() {
        ...
        lIdAngg.setBounds(10, 30, 100, 20);
        lNamaAngg.setBounds(10, 60, 100, 20);
        lIdBuku.setBounds(10, 90, 100, 20);
        lJudulBuku.setBounds(10, 120, 100, 20);
        
        tfIdAngg.setBounds(105, 30, 130, 20);
        tfNamaAngg.setBounds(105, 60, 130, 20);
        tfIdBuku.setBounds(105, 90, 130, 20);
        tfJudulBuku.setBounds(105, 120, 130, 20);
